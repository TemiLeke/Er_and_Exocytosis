...
n2 = y(5);               % Potassium current activating gating variable 
h2 = y(6);               % Potassium current inactivating gating variable 
...
% Membrane Potential %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    dvdt = (Iapp + INa + IK + ICl)/C + (Ica)/(C * Area);    
...
dydt = [dCacdt; dCa_iprdt; dCtdt; dvdt; dn2dt; dh2dt;...
